...
If you like to talk about [CDK](http://cdk.sf.net/), [Bioclipse](http://www.bioclipse.net/) and/or the [Blue Obelisk movement](http://blueobelisk.sourceforge.net/wiki/Main_Page).
Or about my talk on Open Data, Open Standards and Open Source (ODOSOS) in chemoinformatics.

If you happen to be around the Frankfurt Westend campus. In building 4, I think, the Hörsaalzentrum, where the conference is. Please
let me know if you like to meet up. I hope to be online :), but no promise on that... should work at a Uni location, not?
Let's see... This is how to ping me, and don't worry about redundancy.

**Email**: egon.willighagen at gmail dot com <br />
**IRC**: #cdk at irc.freenode.net <br />
**Twitter**: [egonwillighagen](http://twitter.com/egonwillighagen) <br />
**Identica**: [chemblaics](http://identi.ca/chemblaics) <br />
**Blog**: just leave a reply to this message <br />
