...
(see for example [[1](http://chem-bla-ics.blogspot.com/2007/10/one-billion-biochemical-rdf-triples.html),[2](http://chem-bla-ics.blogspot.com/2007/07/rdf-ing-molecular-space.html)]).
...
Yesterday I uploaded a Bioclipse feature that adds a *rdf* manager to handle RDF content, which includes
[SPARQL](http://en.wikipedia.org/wiki/SPARQL) support. The below snippet shows application to the solubility data
[[3 <i class="fa-solid fa-recycle fa-xs"></i>](https://chem-bla-ics.linkedchemistry.info/2008/11/18/solubility-data-in-bioclipse-1.html)]:

See also:

* [One Billion Biochemical RDF Triples!](http://chem-bla-ics.blogspot.com/2007/10/one-billion-biochemical-rdf-triples.html)
