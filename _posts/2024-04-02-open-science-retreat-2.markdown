...
Scholia gives [a nice overview of (macro?)publications on the topic <i class="fa-solid fa-recycle fa-xs"></i>](https://qlever.scholia.wiki/topic/Q57814310).
...
visualizing the corpus with Scholia at [qlever.scholia.wiki/cito/ <i class="fa-solid fa-recycle fa-xs"></i>](https://qlever.scholia.wiki/cito/). There are
...
And this is [what it looks <i class="fa-solid fa-recycle fa-xs"></i>](https://qlever.scholia.wiki/cito/#articles) (yellow) when we compare the contributions
