...
Some time ago I wrote about using [Bioclipse to query to MyExperiment.org SPARQL end point](http://chem-bla-ics.blogspot.com/2009/08/bioclipse-and-sparql-end-points-2.html).
