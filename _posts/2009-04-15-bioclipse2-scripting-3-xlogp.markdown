...
[Bioclipse2](http://www.bioclipse.net/) script to calculate the XLogP value for a given [SMILES](http://www.opensmiles.org/),
using the a CDK-based [XMPP service](http://chem-bla-ics.blogspot.com/search?q=xmpp):
...
* [Bioclipse2 Scripting #2: searching PubChem <i class="fa-solid fa-recycle fa-xs"></i>](https://chem-bla-ics.linkedchemistry.info/2009/02/21/bioclipse2-scripting-2-searching.html)
