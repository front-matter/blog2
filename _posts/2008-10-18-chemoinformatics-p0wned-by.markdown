...
on *chemoinformatics* and *cheminformatics*, so I set up a poll too in [part #1 of this series <i class="fa-solid fa-recycle fa-xs"></i>](https://chem-bla-ics.linkedchemistry.info/2008/07/09/chemoinformatics-p0wned-by.html).
The outcome is clear:

![](/assets/images/cheminfoPoll.png)

The [Obernai meeting <i class="fa-solid fa-recycle fa-xs"></i>](https://chem-bla-ics.linkedchemistry.info/2006/05/28/blue-obelisk-in-obernai-at.html) strongly suggested *chemoinformatics*
...
is the killer. I can no longer resist: I'll follow the wish from my [advisory board <i class="fa-solid fa-recycle fa-xs"></i>](https://chem-bla-ics.linkedchemistry.info/2007/11/27/be-in-my-advisory-board-1-being-good.html),
and the general trend around the world ([except India <i class="fa-solid fa-recycle fa-xs"></i>](https://chem-bla-ics.linkedchemistry.info/2008/08/06/mapping-peoples-interest-google-insight.html)).
