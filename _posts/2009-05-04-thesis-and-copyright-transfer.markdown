...
has not yet, which has social and legal barriers. Like many before me, I made the *mistake* to publish in journals that require me to reassign copyright. Combine that
...
So, if you like a copy of those six chapters, send me an email requesting the a print copy of my thesis from my defense (I still have a few around). (Alternatively,
donate to my project to make these chapters AuthorChoice, but the ACS charges quite some money, and Google Adsense is not compensating for that quite yet.)
